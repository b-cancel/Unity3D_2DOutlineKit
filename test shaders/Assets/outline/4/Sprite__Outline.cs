...
[ExecuteInEditMode]
public class Sprite__Outline : MonoBehaviour {
	private static Material baseMaterial;

	[HideInInspector][SerializeField] private SpriteRenderer outline;

	[SerializeField] private SpriteRenderer parent;

	[SerializeField] private float lineSize = 1f;
	[SerializeField] private Color lineColor = Color.white;
	[SerializeField] private bool scaleLine = true;
