    ...
    public class outline3 : MonoBehaviour
    {
        ...
        public bool Active_SO
        {
            ...
            set
            {
                ...
                if (gameObject.GetComponent<inspectorForOutline3>() != null)//update inspector value
                    gameObject.GetComponent<inspectorForOutline3>().active_SO = active_SO;
                ...
                {
                    if (children[i] != null)
                        children[i].GetComponent<outline3>().Active_SO = active_SO;
                    else
                    {
                        children.RemoveAt(i);
                        i--;
        ...
        public int OrderInLayer_SO
        {
            ...
            set
            {
                ...
                if (gameObject.GetComponent<inspectorForOutline3>() != null)//update inspector value
                    gameObject.GetComponent<inspectorForOutline3>().orderInLayer_SO = orderInLayer_SO;
                ...
                {
                    if (children[i] != null)
                        children[i].GetComponent<outline3>().OrderInLayer_SO = orderInLayer_SO;
                    else
                    {
                        children.RemoveAt(i);
                        i--;
        ...
        public Color Color_SO
        {
            ...
            set
            {
                ...
                if (gameObject.GetComponent<inspectorForOutline3>() != null)//update inspector value
                    gameObject.GetComponent<inspectorForOutline3>().color_SO = color_SO;
                ...
                {
                    if (children[i] != null)
                        children[i].GetComponent<outline3>().Color_SO = color_SO;
                    else
                    {
                        children.RemoveAt(i);
                        i--;
        ...
        public bool Active_O
        {
            ...
            set
            {
                ...
                {
                    if (children[i] != null)
                        children[i].GetComponent<outline3>().Active_O = active_O;
                    else
                    {
                        children.RemoveAt(i);
                        i--;
        ...
        public Color Color_O
        {
            ...
            set
            {
                ...
                {
                    if (children[i] != null)
                        children[i].GetComponent<outline3>().Color_O = color_O;
                    else
                    {
                        children.RemoveAt(i);
                        i--;
        ...
        public int OrderInLayer_O
        {
            ...
            set
            {
                ...
                {
                    if (children[i] != null)
                        children[i].GetComponent<outline3>().OrderInLayer_O = orderInLayer_O;
                    else
                    {
                        children.RemoveAt(i);
                        i--;
        ...
        public float Size_O
        {
            ...
            set
            {
                ...
                {
                    if (children[i] != null)
                        children[i].GetComponent<outline3>().Size_O = size_O;
                    else
                    {
                        children.RemoveAt(i);
                        i--;
        ...
        public bool ScaleWithParentX_O
        {
            ...
            set
            {
                ...
                {
                    if (children[i] != null)
                        children[i].GetComponent<outline3>().ScaleWithParentX_O = scaleWithParentX_O;
                    else
                    {
                        children.RemoveAt(i);
                        i--;
        ...
        public bool ScaleWithParentY_O
        {
            ...
            set
            {
                ...
                {
                    if (children[i] != null)
                        children[i].GetComponent<outline3>().ScaleWithParentY_O = scaleWithParentY_O;
                    else
                    {
                        children.RemoveAt(i);
                        i--;
        ...
        void Update()
        {
            ...
            if (parentGOWithScript != prevParentGOWithScript) //if we change parents
            {
                ...
                if (prevParentGOWithScript != null) //If we had a parent... break all ties with them
                    if (prevParentGOWithScript.GetComponent<outline3>().children.Contains(this.gameObject) == true)
