...
namespace object2DOutlines
{
    ...
    public class concaveOut : outline
    {
        ...
        void OnValidate()
        {
            ...
            {
                //Optimization (IS GENERAL)

                //Debugging (IS GENERAL)

                //Sprite Outline (IS GENERAL)

                //Clipping Mask
                ClipCenter_CM = clipCenter_CM;
                //AlphaCutoff_CM = alphaCutoff_CM; (IS GENERAL)
                //CustomRange_CM = customRange_CM (IS GENERAL)
                //FrontLayer_CM = frontLayer_CM; (IS GENERAL)
                //BackLayer_CM = backLayer_CM; (IS GENERAL)
