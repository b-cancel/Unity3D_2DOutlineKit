...
{
    [CustomEditor(typeof(convexC))]
    public class convexCeditor : Editor
    {
        ...
        public override void OnInspectorGUI() //similar to OnGUI
        {
            serializedObject.Update();

            //Optimization
            GUILayout.Label("thing1", EditorStyles.boldLabel);
