...
{
    [ExecuteInEditMode]
    public class convexOutlineV4 : MonoBehaviour
    {
        ...
        public bool ShowOutline_GOs_InHierarchy_D
        {
            ...
            set
            {
                ...
                if (gameObject.GetComponent<inspectorForConvexOutlineV4>() != null)//update inspector value
                    gameObject.GetComponent<inspectorForConvexOutlineV4>().showOutline_GOs_InHierarchy_D = showOutline_GOs_InHierarchy_D;
        ...
        public bool Active_SO
        {
            ...
            set
            {
                ...
                if (gameObject.GetComponent<inspectorForConvexOutlineV4>() != null)//update inspector value
                    gameObject.GetComponent<inspectorForConvexOutlineV4>().active_SO = active_SO;
        ...
        public int OrderInLayer_SO
        {
            ...
            set
            {
                ...
                if (gameObject.GetComponent<inspectorForConvexOutlineV4>() != null)//update inspector value
                    gameObject.GetComponent<inspectorForConvexOutlineV4>().orderInLayer_SO = orderInLayer_SO;
        ...
        public Color Color_SO
        {
            ...
            set
            {
                ...
                if (gameObject.GetComponent<inspectorForConvexOutlineV4>() != null)//update inspector value
                    gameObject.GetComponent<inspectorForConvexOutlineV4>().color_SO = color_SO;
        ...
        public bool Active_O
        {
            ...
            set
            {
                ...
                if (gameObject.GetComponent<inspectorForConvexOutlineV4>() != null)//update inspector value
                    gameObject.GetComponent<inspectorForConvexOutlineV4>().active_O = active_O;
        ...
        public Color Color_O
        {
            ...
            set
            {
                ...
                if (gameObject.GetComponent<inspectorForConvexOutlineV4>() != null)//update inspector value
                    gameObject.GetComponent<inspectorForConvexOutlineV4>().color_O = color_O;
        ...
        public int OrderInLayer_O
        {
            ...
            set
            {
                ...
                if (gameObject.GetComponent<inspectorForConvexOutlineV4>() != null)//update inspector value
                    gameObject.GetComponent<inspectorForConvexOutlineV4>().orderInLayer_O = orderInLayer_O;
        ...
        public float Size_O
        {
            ...
            set
            {
                ...
                if (forceRetainPorpWithChildren)
                {
                    ...
                    for (int i = 0; i < children.Count; i++)
                    {
                        if (children[i] != null)
                        {
                            ...
                            if (children[i].GetComponent<concaveOutlineV4>() != null) //child has concave outline [DIFFERENT]
                            {
                            ...
                            if (children[i].GetComponent<convexOutlineV4>() != null) //child has convex outline [SAME]
                            {
                ...
                if (gameObject.GetComponent<inspectorForConvexOutlineV4>() != null)//update inspector value
                    gameObject.GetComponent<inspectorForConvexOutlineV4>().size_O = size_O;
        ...
        public bool ScaleWithParentX_O
        {
            ...
            set
            {
                ...
                if (gameObject.GetComponent<inspectorForConvexOutlineV4>() != null)//update inspector value
                    gameObject.GetComponent<inspectorForConvexOutlineV4>().scaleWithParentX_O = scaleWithParentX_O;
        ...
        public bool ScaleWithParentY_O
        {
            ...
            set
            {
                ...
                if (gameObject.GetComponent<inspectorForConvexOutlineV4>() != null)//update inspector value
                    gameObject.GetComponent<inspectorForConvexOutlineV4>().scaleWithParentY_O = scaleWithParentY_O;
