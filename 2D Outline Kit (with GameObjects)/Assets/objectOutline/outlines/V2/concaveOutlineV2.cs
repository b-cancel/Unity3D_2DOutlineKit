...
{
    [ExecuteInEditMode]
    public class concaveOutlineV2 : MonoBehaviour
    {
        //--- Optimization
        ...
        public bool ShowOutline_GOs_InHierarchy_D
        {
            ...
            set
            {
                ...
                if (gameObject.GetComponent<inspectorForConcaveOutlineV2>() != null)//update inspector value
                    gameObject.GetComponent<inspectorForConcaveOutlineV2>().showOutline_GOs_InHierarchy_D = showOutline_GOs_InHierarchy_D;
        ...
        public bool Active_SO
        {
            ...
            set
            {
                ...
                if (gameObject.GetComponent<inspectorForConcaveOutlineV2>() != null)//update inspector value
                    gameObject.GetComponent<inspectorForConcaveOutlineV2>().active_SO = active_SO;
        ...
        public int OrderInLayer_SO
        {
            ...
            set
            {
                ...
                if (gameObject.GetComponent<inspectorForConcaveOutlineV2>() != null)//update inspector value
                    gameObject.GetComponent<inspectorForConcaveOutlineV2>().orderInLayer_SO = orderInLayer_SO;
        ...
        public Color Color_SO
        {
            ...
            set
            {
                ...
                if (gameObject.GetComponent<inspectorForConcaveOutlineV2>() != null)//update inspector value
                    gameObject.GetComponent<inspectorForConcaveOutlineV2>().color_SO = color_SO;
        ...
        public bool ClipCenter_CM
        {
            ...
            set
            {
                ...
                if (gameObject.GetComponent<inspectorForConcaveOutlineV2>() != null)//update inspector value
                    gameObject.GetComponent<inspectorForConcaveOutlineV2>().clipCenter_CM = clipCenter_CM;
        ...
        public float AlphaCutoff_CM
        {
            ...
            set
            {
                ...
                if (gameObject.GetComponent<inspectorForConcaveOutlineV2>() != null)//update inspector value
                    gameObject.GetComponent<inspectorForConcaveOutlineV2>().alphaCutoff_CM = alphaCutoff_CM;
        ...
        public bool CustomRange_CM
        {
            ...
            set
            {
                ...
                if (gameObject.GetComponent<inspectorForConcaveOutlineV2>() != null)//update inspector value
                    gameObject.GetComponent<inspectorForConcaveOutlineV2>().customRange_CM = customRange_CM;
        ...
        public int FrontLayer_CM
        {
            ...
            set
            {
                ...
                if (gameObject.GetComponent<inspectorForConcaveOutlineV2>() != null)//update inspector value
                    gameObject.GetComponent<inspectorForConcaveOutlineV2>().frontLayer_CM = frontLayer_CM;
        ...
        public int BackLayer_CM
        {
            ...
            set
            {
                ...
                if (gameObject.GetComponent<inspectorForConcaveOutlineV2>() != null)//update inspector value
                    gameObject.GetComponent<inspectorForConcaveOutlineV2>().backLayer_CM = backLayer_CM;
        ...
        public bool Active_O
        {
            ...
            set
            {
                ...
                if (gameObject.GetComponent<inspectorForConcaveOutlineV2>() != null)//update inspector value
                    gameObject.GetComponent<inspectorForConcaveOutlineV2>().active_O = active_O;
        ...
        public Color Color_O
        {
            ...
            set
            {
                ...
                if (gameObject.GetComponent<inspectorForConcaveOutlineV2>() != null)//update inspector value
                    gameObject.GetComponent<inspectorForConcaveOutlineV2>().color_O = color_O;
        ...
        public int OrderInLayer_O
        {
            ...
            set
            {
                ...
                if (gameObject.GetComponent<inspectorForConcaveOutlineV2>() != null)//update inspector value
                    gameObject.GetComponent<inspectorForConcaveOutlineV2>().orderInLayer_O = orderInLayer_O;
        ...
        public float Size_O
        {
            ...
            set
            {
                ...
                if (gameObject.GetComponent<inspectorForConcaveOutlineV2>() != null)//update inspector value
                    gameObject.GetComponent<inspectorForConcaveOutlineV2>().size_O = size_O;
        ...
        public bool ScaleWithParentX_O
        {
            ...
            set
            {
                ...
                if (gameObject.GetComponent<inspectorForConcaveOutlineV2>() != null)//update inspector value
                    gameObject.GetComponent<inspectorForConcaveOutlineV2>().scaleWithParentX_O = scaleWithParentX_O;
        ...
        public bool ScaleWithParentY_O
        {
            ...
            set
            {
                ...
                if (gameObject.GetComponent<inspectorForConcaveOutlineV2>() != null)//update inspector value
                    gameObject.GetComponent<inspectorForConcaveOutlineV2>().scaleWithParentY_O = scaleWithParentY_O;
        ...
        public bool PushType_Regular_or_Custom_OP
        {
            ...
            set
            {
                ...
                if (gameObject.GetComponent<inspectorForConcaveOutlineV2>() != null)//update inspector value
                    gameObject.GetComponent<inspectorForConcaveOutlineV2>().pushType_Regular_or_Custom_OP = pushType_Regular_or_Custom_OP;
        ...
        public int ObjsMakingOutline_OPR
        {
            ...
            set
            {
                ...
                if (gameObject.GetComponent<inspectorForConcaveOutlineV2>() != null)//update inspector value
                    gameObject.GetComponent<inspectorForConcaveOutlineV2>().objsMakingOutline_OPR = objsMakingOutline_OPR;
        ...
        public float StartAngle_OPR
        {
            ...
            set
            {
                ...
                if (gameObject.GetComponent<inspectorForConcaveOutlineV2>() != null)//update inspector value
                    gameObject.GetComponent<inspectorForConcaveOutlineV2>().startAngle_OPR = startAngle_OPR;
        ...
        public bool RadialPush_OPR
        {
            ...
            set
            {
                ...
                if (gameObject.GetComponent<inspectorForConcaveOutlineV2>() != null)//update inspector value
                    gameObject.GetComponent<inspectorForConcaveOutlineV2>().radialPush_OPR = radialPush_OPR;
        ...
        public bool StdSize_OPC
        {
            ...
            set
            {
                ...
                if (gameObject.GetComponent<inspectorForConcaveOutlineV2>() != null)//update inspector value
                    gameObject.GetComponent<inspectorForConcaveOutlineV2>().stdSize_OPC = stdSize_OPC;
